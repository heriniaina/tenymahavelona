...
package com.baiboly.katolika.providers;
...
import com.baiboly.katolika.sqlite.SDCardSQLiteOpenHelper;
...
public class MalayalamBibleBookmarksContentProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.baiboly.katolika.providers.malayalambiblebookmarkscontentprovider";
	...
	public static final String INTERNAL_DB_PATH = "/data/data/com.baiboly.katolika/databases";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case BOOKMARKS_BY_ID:
			qb.setTables(BOOKMARKS_TABLE);
			qb.appendWhere(Browser.BookmarkColumns._ID + " = " + uri.getPathSegments().get(1));
			break;		
		default: throw new IllegalArgumentException("Unknown URI " + uri);
		}
	...
	public static String getDbPath() {
		if(mDbPath == null) {
			...
			if (Environment.MEDIA_MOUNTED.equals(state)) {
				mDbPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.baiboly.katolika/db";
			}
			else {
